...
import net.mcreator.rpgclasses.procedures.SplinterStrikeProcedure;
...
public class SecondaryAbilityMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SplinterStrikeProcedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		RpgClassesMod.addNetworkMessage(SecondaryAbilityMessage.class, SecondaryAbilityMessage::buffer, SecondaryAbilityMessage::new, SecondaryAbilityMessage::handler);
	}
}

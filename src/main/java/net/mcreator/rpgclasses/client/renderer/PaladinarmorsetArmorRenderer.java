...
import net.mcreator.rpgclasses.item.model.PaladinarmorsetModel;
import net.mcreator.rpgclasses.item.PaladinarmorsetItem;

public class PaladinarmorsetArmorRenderer extends GeoArmorRenderer<PaladinarmorsetItem> {
	public PaladinarmorsetArmorRenderer() {
		super(new PaladinarmorsetModel());
	...
	@Override
	public RenderType getRenderType(PaladinarmorsetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

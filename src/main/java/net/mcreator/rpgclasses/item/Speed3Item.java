...
import net.mcreator.rpgclasses.procedures.Speed3PlayerFinishesUsingItemProcedure;

public class Speed3Item extends Item {
	public Speed3Item() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Speed3PlayerFinishesUsingItemProcedure.execute(entity);

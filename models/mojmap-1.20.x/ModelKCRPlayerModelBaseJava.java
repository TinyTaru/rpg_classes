	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(32, 48)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 2)
						.addBox(-1.0F, -2.0F, 2.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(-2, -2)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r1 = LeftArm
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(2, 2).addBox(-1.0F, -2.0F, 2.0F, 4.0F, 8.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.0F, 0.0F, 1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r2 = LeftArm
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(2, 2).addBox(-1.0F, -2.0F, 1.0F, 4.0F, 8.0F, 0.0F,
								new CubeDeformation(0.0F)),
